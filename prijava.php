...
<div class="main" style="text-align: center;">
    Nemaš nalog? <a href="registracija.php" style='color:rgba(120,22,77,0.9)'>Registruj se</a></br>
    Prijavi se kao admin: <a href="admin/index.php" style='color:rgba(120,22,77,0.9)'>ADMIN</a></br>
</div>
</div>
</body>
</html>